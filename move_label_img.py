...
# Set paths
label_dir = r"yolo_data_labels"  # Replace with the path to your label files
image_dir = r"yolo_data_labels"   # Replace with the path to your image files
...
for label_filename in os.listdir(label_dir):
    if label_filename.endswith(".txt"):
        ...
        if os.path.exists(image_path):
            ...
            print (f"Moved image {image_path} to {output_dir}")
