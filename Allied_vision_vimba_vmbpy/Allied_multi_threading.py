...
def print_preamble():
    print('//////////////////////////////////////////////')
    print('/// VmbPy Multithreading Vimba Camera  //////')
    print('/////////////////////////////////////////////\n')
    print(flush=True)
...
class FrameProducer(threading.Thread):
    ...
    def setup_camera(self):
        ...
        # self.cam.set_pixel_format(PixelFormat.RGB16)
        # self.cam.set_pixel_format(PixelFormat.YUV422)
        # self.cam.set_pixel_format(PixelFormat.YUV444)
        # self.cam.set_pixel_format(PixelFormat.Y8)
        # self.cam.set_pixel_format(PixelFormat.Y16)
        # self.cam.set_pixel_format(PixelFormat.CbYCr8)
        # self.cam.set_pixel_format(PixelFormat.Grey16)
        # self.cam.set_pixel_format(PixelFormat.BayerRG8)
        # self.cam.set_pixel_format(PixelFormat.BayerBG8)
...
class FrameConsumer:
    ...
    def run(self):
        IMAGE_CAPTION = 'Multithreading Vimba: Press <Enter> to exit'
        KEY_CODE_ENTER = 13
        ...
        while alive:
            ...
            if frames:
                ...
                # save image
                cv2.imwrite('output.jpg', numpy.concatenate(cv_images, axis=1))
